...
void setup() {
  ...
  // We create an updated JSON
  String requestBodyUpdated = createRequestBodyUpdated();

  boolean updated = salesforce.updateData("Account", objId, requestBodyUpdated);

  Serial.print("The Account" + objId + " was updated: ");
...
String createRequestBodyUpdated() {
  DynamicJsonDocument jsonDoc(1024);
  jsonDoc["Name"] = "Test Account Updated";
  String body;
